...
sidebar_position: 4
title: Terra
description: Terra is a third-party open-source terrain generator, available at GitHub. PNX integrates Terra as a solution to server terrain generation, allowing you to use Terra in PNX to create epic level.
keywords: [pnx, documentation, introduction, doc, powernukkitx, terra, terrain, generator, config, pack, world, dimension, overworld, nether, end, height, chunk, section, pack, yml, json, seed, preset, community, reimagend, tartarus, nether, effective, memory, usage, cache, structure, sampler, biome, provider]
---
